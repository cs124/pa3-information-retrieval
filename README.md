...
* The Week 4 videos, slides and readings.
...
1. Clone the git repository for PA3 (this repository) into a folder of your 
   choice by typing this in your terminal:
        ...
        git clone https://github.com/cs124/pa3-information-retrieval.git

2. Enter the project root directory and activate your cs124 conda environment by
   doing:
   
        cd pa3-information-retrieval
...
2. Now go to File->Open Notebook. Go to the GitHub tab. It will ask you to log 
   ...
   https://github.com/cs124/pa3-information-retrieval into the search box and hit enter. 
   It should show:
   
            Repository: cs124/pa3-information-retrieval
            Branch:  Main
...
2. Upload the zip file as your solution to the PA3 Information Retrieval assignment in 
...
2. Run the following command to transfer that zip file over from WSL to your local computer:
      ...
      cp ~/cs124/pa3-information-retrieval/submission.zip /mnt/c/Users/YOUR_USER_NAME/OneDrive/Desktop/
...
local machine.
   ...
   - __[macOS/Linux/Ubuntu for Windows]__
      ...
      This should return something like
            ...
            /afs/.ir/users/YOUR/SUNET/ID/cs124/pa3-information-retrieval

      Copy that command and append submission.zip to it:

            /afs/.ir/users/YOUR/SUNET/ID/cs124/pa3-information-retrieval/submission.zip
      ...
      Then, cd into a local folder where you'd like to save the submission zip, and use the following command to copy the zip from Myth to your local machine:
         ...
         scp -r [SUNet]@[rice/myth][rice/myth machine number].stanford.edu:/afs/.ir/users/YOUR/SUNET/ID/cs124/pa3-information-retrieval/submission.zip .
...
pa3-information-retrieval/deps. Go to the file explorer on the left-hand side and download
those as well.
